...
public class GameBoard {
    ...
    private boolean move(int row, int col, int direcaoHorizontal, int direcaoVertical, Direction dir) {
        ...
        while (move) {
            ...
            if (checkOutBounds(dir, newRow, newCol))
                break;
    ...
    private void moveTiles(Direction dir) {
        ...
        if (dir == Direction.LEFT) { // Quando pressionado Esquerda, verifica posição, altera direção e move
            ...
            for (int row = 0; row < ROWS; row++) {
                for (int col = 0; col < COLS; col++) {
                    ...
                    if (!podeMover)
                        ...
                        move(row, col, direcaoHorizontal, direcaoVertical, dir);

                }
            }
        }

        else if (dir == Direction.RIGHT) { // Quando pressionado Direita, verifica posição, altera direção e move
        ...
        else if (dir == Direction.UP) { // Quando pressionado Cima, verifica posição, altera direção e move
        ...
        else if (dir == Direction.DOWN) { // Quando pressionado Baixo, verifica posição, altera direção e move
        ...
        if (podeMover) {
            ...
            spawnRandom(); // verifica lugar livre e coloca um quadrado de valor "2"

            checarPerdeu(); // checar se perdeu

        }

    }

    private void checarPerdeu() { // quando não há mais espaço para movimento dos quadrados
    ...
    private boolean checarTilesEmVolta(int row, int col, tile current){ //Verifica se há quadrados do lado pressionado
    ...
    private void checkKeys(){   //Verificador da tecla pressionada
